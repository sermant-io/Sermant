...
public class RedissonDefinition implements EnhanceDefinition {
    ...
    private static final String REDISSON_METHOD_INTERCEPTOR_CLASS =
            "com.huawei.flowrecord.RedissonInterceptor";
    ...
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[]{
                MethodInterceptPoint.newInstMethodInterceptPoint(REDISSON_METHOD_INTERCEPTOR_CLASS,
                        ElementMatchers.<MethodDescription>namedOneOf("writeAsync", "readAsync", "evalWriteAllAsync", "writeAllAsync",
