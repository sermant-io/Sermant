...
import io.sermant.visibility.interceptor.SpringCloudRegistryInterceptor;
 ...
 * @since 2022-12-05
 */
public class SpringCloudRegistryDeclarer extends AbstractCollectorDeclarer {
    private static final String ENHANCE_CLASS = "org.springframework.cloud.client.serviceregistry.ServiceRegistry";
    private static final String INTERCEPT_CLASS = SpringCloudRegistryInterceptor.class.getCanonicalName();
