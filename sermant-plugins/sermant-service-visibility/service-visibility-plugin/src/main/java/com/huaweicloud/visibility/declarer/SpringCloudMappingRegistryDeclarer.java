...
import com.huaweicloud.visibility.interceptor.SpringCloudMappingRegistryInterceptor;

/**
 * SpringCloud mapping registration interceptor Declarer
 *
 * @author zhp
 * @since 2022-12-05
 */
public class SpringCloudMappingRegistryDeclarer extends AbstractCollectorDeclarer {
    private static final String ENHANCE_CLASS = "org.springframework.web.servlet.handler.AbstractHandlerMethodMapping";

    private static final String INTERCEPT_CLASS = SpringCloudMappingRegistryInterceptor.class.getCanonicalName();
