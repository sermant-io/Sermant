...
/**
 * OkHttpClientInterceptorChainInterceptor test
 *
 * @author zhp
 * @since 2025-04-11
 */
public class OkHttpClientInterceptorChainInterceptorTest {
    ...
    public OkHttpClientInterceptorChainInterceptorTest() throws NoSuchMethodException {
    }
    ...
    public void test() throws Exception {
        OkHttpClientInterceptorChainInterceptor interceptor = new OkHttpClientInterceptorChainInterceptor();
    ...
    private ExecuteContext buildContext(String url) {
        ...
        return ExecuteContext.forMemberMethod(call, method, new Object[]{httpRequest}, null, null);
    }

    private ExecuteContext buildErrorContext() {
        Call call = Mockito.mock(Call.class);
        return ExecuteContext.forMemberMethod(call, method, new Object[]{""}, null, null);
    }
