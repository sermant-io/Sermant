...
public class SpringFactoriesInterceptorTest {
    private static final String RESPONSE_CLASS = "io.sermant.flowcontrol.inject.DefaultClientHttpResponse";

    private static final String RETRY_RESPONSE_CLASS = "io.sermant.flowcontrol.inject.RetryClientHttpResponse";
