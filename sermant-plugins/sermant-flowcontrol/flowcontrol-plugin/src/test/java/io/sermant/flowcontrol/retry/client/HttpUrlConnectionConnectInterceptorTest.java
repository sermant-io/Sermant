 ...
 * @since 2025-04-11
 */
public class HttpUrlConnectionConnectInterceptorTest {
    ...
    public HttpUrlConnectionConnectInterceptorTest() throws NoSuchMethodException {
    }
    ...
    public void test() throws Exception {
        HttpUrlConnectionConnectInterceptor interceptor = new HttpUrlConnectionConnectInterceptor();
        ...
        interceptor.doBefore(executeContext);
        HttpURLConnection connection = (HttpURLConnection) executeContext.getObject();
        Assert.assertEquals(code, connection.getResponseCode());
        Assert.assertEquals(resultMsg, connection.getResponseMessage());
        ...
        interceptor.doBefore(executeContext);
        connection = (HttpURLConnection) executeContext.getObject();
        Assert.assertEquals(HttpStatus.SC_INTERNAL_SERVER_ERROR, connection.getResponseCode());
