 ...
 * for dubbo3 consumer filter
 *
 * @author chengyouling
 * @since 2025-02-27
 */
public class ApacheDubboConsumerContextFilterDeclarer extends AbstractPluginDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
            InterceptDeclarer.build(MethodMatcher.nameEquals("invoke"), new ApacheDubboInterceptor())
        };
    }
}
