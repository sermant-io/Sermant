...
import io.sermant.mq.grayscale.config.Grayscale;
...
public class CseMqGrayConfigHandler {
    ...
    private MqGrayscaleConfig buildGrayConfig(Map<String, Object> map) {
        ...
        MessageGrayBase messageGrayBase = new MessageGrayBase();
        messageGrayBase.setMessageFilter(messageFilter);
        config.setBase(messageGrayBase);
