...
public class MqGrayscaleConfig implements PluginConfig {
    ...
    private MessageGrayBase messageGrayBase;
    ...
    public MessageGrayBase getBase() {
        return messageGrayBase;
    }

    public void setBase(MessageGrayBase messageGrayBase) {
        this.messageGrayBase = messageGrayBase;
    }
