...
public class MqPushConsumerConstructorDeclarer extends MqAbstractDeclarer {
    ...
    private static final String QUEUE_PARAMETER = "org.apache.rocketmq.remoting.RPCHook";

    private static final String[] METHOD_PARAM_TYPES_1 = {
            STRING_PARAMETER, HOOK_PARAMETER, QUEUE_PARAMETER
    };

    private static final String[] METHOD_PARAM_TYPES_2 = {
            STRING_PARAMETER, STRING_PARAMETER, HOOK_PARAMETER, QUEUE_PARAMETER
    };

    private static final String[] METHOD_PARAM_TYPES_3 = {
            STRING_PARAMETER, HOOK_PARAMETER, QUEUE_PARAMETER, "boolean", STRING_PARAMETER
    };

    private static final String[] METHOD_PARAM_TYPES_4 = {
            STRING_PARAMETER, STRING_PARAMETER, HOOK_PARAMETER, QUEUE_PARAMETER, "boolean", STRING_PARAMETER
    };
