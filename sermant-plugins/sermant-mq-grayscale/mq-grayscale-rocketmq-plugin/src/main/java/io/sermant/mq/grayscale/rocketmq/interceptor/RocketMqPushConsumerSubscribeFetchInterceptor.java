 ...
 * @since 2024-05-27
 **/
public class RocketMqPushConsumerSubscribeFetchInterceptor extends RocketMqAbstractInterceptor {
    @Override
    public ExecuteContext doAfter(ExecuteContext context) throws Exception {
        ...
        buildGroupAndClientConfig(pushConsumer.getNamesrvAddr(), (String) context.getArguments()[0],
