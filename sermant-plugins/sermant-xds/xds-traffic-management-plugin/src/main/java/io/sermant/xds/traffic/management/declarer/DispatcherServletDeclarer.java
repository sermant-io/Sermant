...
import io.sermant.xds.traffic.management.interceptor.DispatcherServletInterceptor;
 ...
 * @since 2022-02-09
 */
public class DispatcherServletDeclarer extends AbstractXdsDeclarer {
    /**
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
                InterceptDeclarer.build(MethodMatcher.nameEquals("doService"),
                        new DispatcherServletInterceptor())
        };
    }
}
