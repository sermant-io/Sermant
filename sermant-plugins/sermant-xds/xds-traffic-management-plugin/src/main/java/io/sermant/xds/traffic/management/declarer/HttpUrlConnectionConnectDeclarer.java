...
import io.sermant.xds.traffic.management.interceptor.HttpUrlConnectionConnectInterceptor;
 ...
 * @since 2024-12-20
 */
public class HttpUrlConnectionConnectDeclarer extends AbstractXdsDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
                InterceptDeclarer.build(MethodMatcher.nameEquals(METHOD_NAME),
                        new HttpUrlConnectionConnectInterceptor())};
    }
}
