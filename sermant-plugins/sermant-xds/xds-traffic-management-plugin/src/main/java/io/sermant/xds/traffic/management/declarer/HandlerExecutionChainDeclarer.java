...
import io.sermant.xds.traffic.management.interceptor.HandlerExecutionChainInterceptor;

/**
 * Inject Spring Web interceptor
 *
 * @author lilai
 * @since 2025-06-14
 */
public class HandlerExecutionChainDeclarer extends AbstractXdsDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
                InterceptDeclarer.build(MethodMatcher.nameEquals(METHOD_NAME),
                        new HandlerExecutionChainInterceptor())
        };
    }
}
