...
import io.sermant.xds.traffic.management.interceptor.SpringFactoriesInterceptor;
 ...
 * @since 2025-06-04
 */
public class SpringFactoriesDeclarer extends AbstractXdsDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
                InterceptDeclarer.build(MethodMatcher.nameContains("loadSpringFactories", "loadFactoryNames"),
                        new SpringFactoriesInterceptor())
        };
    }
}
