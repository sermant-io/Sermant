...
import io.sermant.xds.traffic.management.interceptor.HttpUrlConnectionResponseStreamInterceptor;
 ...
 * @since 2024-12-20
 */
public class HttpUrlConnectionResponseStreamDeclarer extends AbstractXdsDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[] {
                InterceptDeclarer.build(MethodMatcher.nameEquals(METHOD_NAME),
                        new HttpUrlConnectionResponseStreamInterceptor())
        };
    }
}
