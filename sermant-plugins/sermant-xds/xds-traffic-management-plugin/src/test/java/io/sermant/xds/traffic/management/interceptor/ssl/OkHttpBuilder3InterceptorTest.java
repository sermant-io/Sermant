...
public class OkHttpBuilder3InterceptorTest {
    private OkHttpBuilder3Interceptor interceptor;
    ...
    /**
     * TC2: SSL enabled but context object is not OkHttpClient3Builder
     */
    @Test
    void testBeforeWhenObjectNotOkHttpClient() throws Exception {
        when(executeContext.getObject()).thenReturn(new Object()); // Not OkHttpClient3Builder
    ...
    /**
     * TC3: SSL enabled with valid OkHttpClient3Builder and empty password
     */
    @Test
    void testBeforeWhenSslEnabledAndPasswordEmpty() throws Exception {
        when(xdsSecurityService.isSslEnabled()).thenReturn(true);
        when(executeContext.getObject()).thenReturn(builder);
        ...
        verify(builder).sslSocketFactory(any(SSLSocketFactory.class), any(X509TrustManager.class));
    }

    /**
     * TC4: SSL enabled with valid OkHttpClient3Builder and non-empty password
     */
    @Test
