...
public class OkHttpBuilder2InterceptorTest {
    ...
    /**
     * TC2: SSL enabled but context object is not OkHttpClient
     */
    @Test
    void testBeforeWhenObjectNotOkHttpClient() throws Exception {
        when(executeContext.getObject()).thenReturn(new Object()); // Not OkHttpClient
    ...
    void testBeforeWhenSslEnabledAndPasswordEmpty() throws Exception {
        ...
        verify(okHttpClient).setSslSocketFactory(any(SSLSocketFactory.class));
    }

    /**
     * TC4: SSL enabled with valid OkHttpClient and non-empty password
     */
    @Test
