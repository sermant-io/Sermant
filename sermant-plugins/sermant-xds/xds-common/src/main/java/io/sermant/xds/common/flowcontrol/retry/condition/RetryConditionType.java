...
public enum RetryConditionType {
    ...
    /**
     * condition Type, 0: Retry condition based on the result. 1: Retry condition based on the exception. 2: Retry
     * condition based on both the status code and the exception.
     */
