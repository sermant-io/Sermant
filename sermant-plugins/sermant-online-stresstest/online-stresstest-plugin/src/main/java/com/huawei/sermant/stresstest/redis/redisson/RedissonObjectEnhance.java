...
public class RedissonObjectEnhance implements EnhanceDefinition {
    ...
    private static final String INTERCEPT_CLASS =
        "com.huawei.sermant.stresstest.redis.redisson.RedissonObjectInterceptor";
    ...
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[] {
            MethodInterceptPoint.newConstructorInterceptPoint(INTERCEPT_CLASS, ElementMatchers.any())};
    }
}
