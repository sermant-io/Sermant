...
public class KafkaProducerEnhance implements EnhanceDefinition {
    ...
    private static final String INTERCEPT_CLASS = "com.huawei.sermant.stresstest.kafka.KafkaProducerInterceptor";
    ...
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[] {
            MethodInterceptPoint.newInstMethodInterceptPoint(INTERCEPT_CLASS, ElementMatchers.named("doSend"))};
    }
}
