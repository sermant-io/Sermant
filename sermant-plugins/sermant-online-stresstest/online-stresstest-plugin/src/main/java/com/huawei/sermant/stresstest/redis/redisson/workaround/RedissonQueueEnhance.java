...
public class RedissonQueueEnhance implements EnhanceDefinition {
    private static final String INTERCEPT_CLASS =
        "com.huawei.sermant.stresstest.redis.redisson.workaround.RedissonShadowInterceptor";
    ...
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[] {
            MethodInterceptPoint.newInstMethodInterceptPoint(INTERCEPT_CLASS, ElementMatchers.named("trySetCapacity"))};
    }
}
