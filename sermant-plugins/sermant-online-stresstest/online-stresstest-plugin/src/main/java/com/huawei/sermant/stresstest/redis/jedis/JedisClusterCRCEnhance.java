...
public class JedisClusterCRCEnhance implements EnhanceDefinition {
    ...
    private static final String INTERCEPT_CLASS = "com.huawei.sermant.stresstest.redis.jedis.JedisClusterInterceptor";
    ...
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[] {
            MethodInterceptPoint.newStaticMethodInterceptPoint(INTERCEPT_CLASS, ElementMatchers.named("getSlot"))};
    }
}
