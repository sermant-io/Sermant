...
public class KafkaConsumerEnhance implements EnhanceDefinition {
    ...
    private static final String INTERCEPT_CLASS = "com.huawei.sermant.stresstest.kafka.KafkaConsumerInterceptor";
    ...
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[] {
            MethodInterceptPoint.newInstMethodInterceptPoint(INTERCEPT_CLASS, ElementMatchers.named("createConsumer"))};
    }
}
