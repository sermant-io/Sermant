...
public class RedissonClusterEnhance implements EnhanceDefinition {
    ...
    private static final String INTERCEPT_CLASS =
        "com.huawei.sermant.stresstest.redis.redisson.RedissonClusterInterceptor";
    ...
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[] {
            MethodInterceptPoint.newInstMethodInterceptPoint(INTERCEPT_CLASS, ElementMatchers.named("calcSlot"))};
    }
}
