...
import io.sermant.discovery.interceptors.httpclient.HttpClient4xInterceptorTest.Strategy;
import io.sermant.discovery.interceptors.httpclient.HttpClient4xInterceptorTest.TestInvokerService;
