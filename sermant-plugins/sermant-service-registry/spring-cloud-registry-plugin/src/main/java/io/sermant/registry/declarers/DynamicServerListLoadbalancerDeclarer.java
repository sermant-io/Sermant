...
import io.sermant.registry.interceptors.DynamicServerListInterceptor;
...
public class DynamicServerListLoadbalancerDeclarer extends AbstractDoubleRegistryDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
            InterceptDeclarer.build(MethodMatcher.nameEquals("updateListOfServers")
                    .and(MethodMatcher.paramCountEquals(0)), INTERCEPT_CLASS)
        };
    }
}
