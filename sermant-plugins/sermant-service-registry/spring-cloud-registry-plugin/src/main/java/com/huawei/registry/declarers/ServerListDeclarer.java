...
import com.huawei.registry.interceptors.ServerListInterceptor;
 ...
 * @since 2021-12-16
 */
public class ServerListDeclarer extends AbstractPluginDeclarer {
    /**
     * 增强类的全限定名
     */
     ...
     * 拦截类的全限定名
     */
    private static final String INTERCEPT_CLASS = ServerListInterceptor.class.getCanonicalName();
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
            InterceptDeclarer.build(MethodMatcher.nameEquals("getUpdatedListOfServers"), INTERCEPT_CLASS)
        };
    }
}
