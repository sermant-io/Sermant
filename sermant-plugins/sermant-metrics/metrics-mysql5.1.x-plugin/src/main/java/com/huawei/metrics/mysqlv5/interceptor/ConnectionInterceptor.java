...
package com.huawei.metrics.mysqlv5.interceptor;

import com.huawei.metrics.common.Constants;
import com.huawei.metrics.entity.MetricsRpcInfo;
import com.huawei.metrics.interceptor.AbstractMysqlInterceptor;
...
public class ConnectionInterceptor extends AbstractMysqlInterceptor {
    ...
    public ExecuteContext collectMetrics(ExecuteContext context) {
        ...
        try {
            ...
            ConnectionProperties connectionProperties = (ConnectionProperties) context.getObject();
            MetricsRpcInfo metricsRpcInfo = initMetricsRpcInfo(context, connectionProperties.getUseSSL(),
