...
import io.sermant.implement.service.inject.InjectServiceImpl;
...
public class SpringFactoriesInterceptorTest {
    private static final String PROPERTY_LOCATOR_CLASS = "io.sermant.dynamic.config.source.SpringPropertyLocator";

    private static final String EVENT_PUBLISHER_CLASS = "io.sermant.dynamic.config.source.SpringEventPublisher";
