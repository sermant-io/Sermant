...
import com.huaweicloud.sermant.tag.transmission.kafka.interceptors.KafkaConsumerRecordInterceptor;

/**
 * kafka interception point declarer to obtain message content, supporting 1.x, 2.x, 3.x
 *
 * @author lilai
 * @since 2023-07-18
 */
public class KafkaConsumerRecordDeclarer extends AbstractPluginDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
                InterceptDeclarer.build(MethodMatcher.nameEquals("value"),
                        new KafkaConsumerRecordInterceptor())
        };
    }
}
