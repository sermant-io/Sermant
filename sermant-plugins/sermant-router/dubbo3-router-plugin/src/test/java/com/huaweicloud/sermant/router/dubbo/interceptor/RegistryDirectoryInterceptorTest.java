...
public class RegistryDirectoryInterceptorTest {
    ...
    private static final URL APACHE_URL = URL.valueOf(
            "dubbo://localhost:8081/com.huaweicloud.foo.FooTest?foo=bar&version=0.0.1&application=" + SERVICE_NAME);


    private static final String SERVICE_INTERFACE = "com.huaweicloud.foo.FooTest";
