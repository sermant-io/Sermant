...
import io.sermant.router.dubbo.interceptor.ServiceDiscoveryRegistryDirectoryInterceptor;
 ...
 * @since 2024-02-17
 */
public class ServiceDiscoveryRegistryDirectoryDeclarer extends AbstractPluginDeclarer {
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
                InterceptDeclarer.build(MethodMatcher.nameEquals(METHOD_NAME),
                        new ServiceDiscoveryRegistryDirectoryInterceptor())
        };
    }
}
