...
public class ClusterUtilsServiceTest {
    private static final URL ALIBABA_URL =
            URL.valueOf("dubbo://localhost:8080/io.sermant.foo.BarTest?bar=foo&application=bar");

    private static final org.apache.dubbo.common.URL APACHE_URL = org.apache.dubbo.common.URL
            .valueOf("dubbo://localhost:8081/io.sermant.foo.FooTest?foo=bar&application=foo");
    ...
    public void testAlibaba() {
        ...
        Assert.assertNull(DubboCache.INSTANCE.getApplication("io.sermant.foo.BarTest"));
        ...
        Assert.assertEquals("bar", DubboCache.INSTANCE.getApplication("io.sermant.foo.BarTest"));
    ...
    public void testApache() {
        ...
        clusterUtilsService.doBefore(arguments);
        Assert.assertNull(DubboCache.INSTANCE.getApplication("io.sermant.foo.FooTest"));
        ...
        Assert.assertNull(resultMap.get(RouterConstant.PARAMETERS_KEY_PREFIX + "bar"));
        Assert.assertEquals("foo", resultMap.get(null));
        Assert.assertEquals("foo", DubboCache.INSTANCE.getApplication("io.sermant.foo.FooTest"));
