...
public class DubboReflectUtilsTest {
    private static final URL ALIBABA_URL = URL
            .valueOf("dubbo://localhost:8080/io.sermant.foo.BarTest?bar=foo&version=0.0.1");
    ...
    public void testGetServiceInterface() {
        Assert.assertEquals("io.sermant.foo.BarTest", DubboReflectUtils.getServiceInterface(ALIBABA_URL));
        Assert.assertEquals("io.sermant.foo.FooTest", DubboReflectUtils.getServiceInterface(APACHE_URL));
    }
    ...
    public void testGetServiceKey() {
        Assert.assertEquals("io.sermant.foo.BarTest:0.0.1", DubboReflectUtils.getServiceKey(ALIBABA_URL));
        Assert.assertEquals("io.sermant.foo.FooTest:0.0.1", DubboReflectUtils.getServiceKey(APACHE_URL));
    }
