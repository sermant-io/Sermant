...
public class SpringCloudLoadBalancerClientInterceptor extends AbstractCallInterceptor<ServiceInstance> {
    @Override
    protected String getHost(ServiceInstance serviceInstance) {
        return StringUtils.getString(serviceInstance.getHost());
    }

    @Override
    protected String getPort(ServiceInstance serviceInstance) {
        return StringUtils.getString(serviceInstance.getPort());
    }
