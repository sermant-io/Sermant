...
import io.sermant.removal.interceptor.SpringBootCacheManagerInterceptor;

/**
 * SpringBoot service call interception definition
 *
 * @author zhp
 * @since 2023-02-17
 */
public class SpringBootCacheManagerDeclarer extends AbstractPluginDeclarer {
    private static final String ENHANCE_CLASS = "io.sermant.discovery.service.lb.cache.InstanceCacheManager";
