 ...
 * @since 2023-12-23
 */
public class KafkaConsumerSubscribeInterceptorTest {
    private KafkaConsumerSubscribeInterceptor interceptor;
    ...
    @Before
    public void setUp() {
        interceptor = new KafkaConsumerSubscribeInterceptor();
    ...
    public void testAfter() {
        ...
        Assert.assertEquals(topics,
                KafkaConsumerController.getKafkaConsumerCache().get(mockConsumer.hashCode()).getOriginalTopics());
    }
}
