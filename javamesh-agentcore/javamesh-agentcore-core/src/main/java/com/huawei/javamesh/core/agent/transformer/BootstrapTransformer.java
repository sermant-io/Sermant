...
import com.huawei.javamesh.core.agent.template.BootstrapConstTemplate;
import com.huawei.javamesh.core.agent.template.BootstrapInstTemplate;
import com.huawei.javamesh.core.agent.template.BootstrapStaticTemplate;
        ...
        private DynamicType.Builder<?> doResolve(DynamicType.Builder<?> builder, Class<?> templateCls,
            ...
            final Interceptor originInterceptor = originInterceptorName == null ? null :
                    InterceptorLoader.getInterceptor(originInterceptorName, classLoader,
                            com.huawei.javamesh.core.lubanops.bootstrap.Interceptor.class);
