 ...
 * <p>加载配置信息主要分两步：
 * <pre>
 *     1.加载配置文件为配置信息{@link #getConfigHolder(List, Map)}
...
public interface LoadConfigStrategy<T> {
     ...
     * @return 配置信息主要承载对象
     */
    T getConfigHolder(List<File> configs, Map<String, String> argsMap);
    ...
    class DefaultLoadConfigStrategy implements LoadConfigStrategy<Object> {
        ...
        @Override
        public Object getConfigHolder(List<File> configs, Map<String, String> argsMap) {
