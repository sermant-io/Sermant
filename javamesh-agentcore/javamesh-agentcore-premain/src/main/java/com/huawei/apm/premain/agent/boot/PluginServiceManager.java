...
public enum PluginServiceManager {
    ...
    private void loadAllPluginServices(ClassLoader classLoader) {
        ServiceLoader<PluginService> pluginServiceList = AgentSpiLoader.load(PluginService.class);
