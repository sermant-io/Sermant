...
const eventName = reactive({
  ...
  FLOW_CONTROL_INSTANCEISOLATION: "隔离规则更新",
  FLOW_CONTROL_MATCHGROUP: "流量匹配规则更新",
  FLOW_CONTROL_RATELIMITING: "限流规则更新",
  FLOW_CONTROL_RETRY: "重试规则更新",
  FLOW_CONTROL_SYSTEM: "系统流控规则更新",
  FLOW_CONTROL_BULKHEAD_ENABLE: "隔离舱规则生效",
  FLOW_CONTROL_CIRCUITBREAKER_ENABLE: "熔断规则生效",
  FLOW_CONTROL_FAULTINJECTION_ENABLE: "错误注入规则生效",
  FLOW_CONTROL_INSTANCEISOLATION_ENABLE: "隔离规则生效",
  FLOW_CONTROL_RATELIMITING_ENABLE: "限流规则生效",
  FLOW_CONTROL_SYSTEM_ENABLE: "系统流控规则生效",
  FLOW_CONTROL_BULKHEAD_DISENABLE: "隔离舱规则失效",
  FLOW_CONTROL_CIRCUITBREAKER_DISENABLE: "熔断规则失效",
  FLOW_CONTROL_FAULTINJECTION_DISENABLE: "错误注入规则失效",
  FLOW_CONTROL_INSTANCEISOLATION_DISENABLE: "隔离规则失效",
  FLOW_CONTROL_RATELIMITING_DISENABLE: "限流规则失效",
  FLOW_CONTROL_SYSTEM_DISENABLE: "系统流控规则失效",
});
