...
Execute *maven* command to package the **JavaMesh** project's [demo module](javamesh-samples/javamesh-example).

```shell
mvn clean package -Dmaven.test.skip -Pexample
```

Execute *maven* command to package the **JavaMesh** project's [back-end module](javamesh-samples/javamesh-backend).
