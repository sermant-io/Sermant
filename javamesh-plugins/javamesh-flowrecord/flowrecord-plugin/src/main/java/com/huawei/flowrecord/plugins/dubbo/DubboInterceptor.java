...
import com.huawei.javamesh.core.lubanops.bootstrap.collector.api.FutureStatsAccessor;
import com.huawei.javamesh.core.lubanops.bootstrap.trace.Headers;
import com.huawei.javamesh.core.lubanops.bootstrap.trace.SpanEvent;
import com.huawei.javamesh.core.lubanops.bootstrap.trace.StartTraceRequest;
...
public class DubboInterceptor implements InstanceMethodInterceptor {
    ...
    private SpanEvent processProvider(String className, String methodName, Invocation invocation, String source) {
        ...
        if (StringUtil.isBlank(apmTraceId)) {
