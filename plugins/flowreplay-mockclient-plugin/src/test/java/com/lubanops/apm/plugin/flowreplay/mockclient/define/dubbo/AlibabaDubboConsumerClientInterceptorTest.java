 ...
 * @since 2021-05-11
 */
public class AlibabaDubboConsumerClientInterceptorTest {
    @Test
    public void checkMockResult() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException {
        ...
        Method method = AlibabaDubboConsumerClientInterceptor.class.getDeclaredMethod("checkMockResult", MockResult.class, String.class);
        method.setAccessible(true);
        Assert.assertFalse((boolean) method.invoke(AlibabaDubboConsumerClientInterceptor.class.newInstance(), mockResultA, "subCallKey"));
        Assert.assertFalse((boolean) method.invoke(AlibabaDubboConsumerClientInterceptor.class.newInstance(), mockResultB, "subCallKey"));
        Assert.assertFalse((boolean) method.invoke(AlibabaDubboConsumerClientInterceptor.class.newInstance(), mockResultC, "subCallKey"));
        Assert.assertFalse((boolean) method.invoke(AlibabaDubboConsumerClientInterceptor.class.newInstance(), mockResultD, "subCallKey"));
        Assert.assertTrue((boolean) method.invoke(AlibabaDubboConsumerClientInterceptor.class.newInstance(), mockResultE, "subCallKey"));
    }
}