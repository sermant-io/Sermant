...
/**
 * Apache dubbo Provider 增强插件,用于在mock过程中传递上下文Context
 *
 * @author luanwenfei
 * @version 0.0.1
 * @since 2021-04-23
 */
public class DubboProviderClientInterceptor implements InstanceMethodInterceptor {
    private static final Logger LOGGER = LoggerFactory.getLogger(DubboProviderClientInterceptor.class);
