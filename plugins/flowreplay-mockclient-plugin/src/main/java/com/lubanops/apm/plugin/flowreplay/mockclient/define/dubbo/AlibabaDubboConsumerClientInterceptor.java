...
/**
 * Alibaba dubbo consumer 拦截并进行mock
 *
 * @author luanwenfei
 * @version 0.0.1
 * @since 2021-04-28
 */
public class AlibabaDubboConsumerClientInterceptor implements InstanceMethodInterceptor {
    private static final Logger LOGGER = LoggerFactory.getLogger(AlibabaDubboConsumerClientInterceptor.class);
