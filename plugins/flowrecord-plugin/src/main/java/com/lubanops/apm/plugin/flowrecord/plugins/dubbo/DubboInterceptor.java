...
import static com.lubanops.apm.plugin.flowrecord.utils.KafkaProducerUtil.sendMessage;
...
public class DubboInterceptor implements InstanceMethodInterceptor {
    ...
    private void sendRecorder(Invocation invocation, Result ret, boolean entry, Invoker invoker, String jobId,
        ...
        sendMessage(PluginConfigUtil.getValueByKey(ConfigConst.KAFKA_REQUEST_TOPIC), serializedrequest);
    }
    ...
    private void correlationInsert(Invoker invoker, Invocation invocation) {
        ...
        if (relationContext.get(ConfigConst.RECORD_LIST) == null) {
