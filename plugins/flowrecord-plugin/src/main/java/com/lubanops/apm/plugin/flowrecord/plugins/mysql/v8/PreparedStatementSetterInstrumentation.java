...
public class PreparedStatementSetterInstrumentation extends PreparedStatementInstrumentation {
    ...
    private static final String INTERCEPT_CLASS = "org.apache.skywalking.apm.plugin.jdbc.JDBCPreparedStatementSetterInterceptor";

    @Override
    public MethodInterceptPoint[] getMethodInterceptPoints() {
        return new MethodInterceptPoint[]{
                MethodInterceptPoint.newInstMethodInterceptPoint(INTERCEPT_CLASS, getMethodsMatcher())
        };
    }
