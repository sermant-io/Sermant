...
package com.huawei.sermant.core.lubanops.core.container.module;

import com.google.inject.multibindings.Multibinder;
import com.huawei.sermant.core.lubanops.bootstrap.api.CircuitBreaker;
import com.huawei.sermant.core.lubanops.bootstrap.api.EventDispatcher;
import com.huawei.sermant.core.lubanops.bootstrap.trace.TraceReportService;
import com.huawei.sermant.core.lubanops.core.api.AgentService;
import com.huawei.sermant.core.lubanops.core.api.IntervalTaskManager;
import com.huawei.sermant.core.lubanops.core.event.ApmEventDispatcher;
import com.huawei.sermant.core.lubanops.core.trace.TraceReportServiceImpl;
import com.huawei.sermant.core.lubanops.core.transfer.circuit.ReportCircuitBreaker;
import com.huawei.sermant.core.lubanops.core.executor.ExecuteRepository;
import com.huawei.sermant.core.lubanops.core.executor.manager.DefaultExecuteRepository;
import com.huawei.sermant.core.lubanops.core.master.MasterService;
import com.huawei.sermant.core.lubanops.core.master.RegionMasterService;
import com.huawei.sermant.core.lubanops.core.monitor.HarvestTaskManager;
import com.huawei.sermant.core.lubanops.core.monitor.MonitorReportService;
import com.huawei.sermant.core.lubanops.core.monitor.MonitorReportServiceImpl;
import com.huawei.sermant.core.lubanops.core.transfer.InvokerService;
import com.huawei.sermant.core.lubanops.core.transfer.TransferInvokerService;
