...
package com.huawei.sermant.core.lubanops.bootstrap.transaction;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.huawei.sermant.core.lubanops.bootstrap.collector.api.AbstractPrimaryKeyValueAggregator;
