...
package io.sermant.agentcore.tests.plugin.declarer.methodmatch;
...
public class TestMethodMatcherDeclarer extends AbstractPluginDeclarer {
    ...
    public ClassMatcher getClassMatcher() {
        return ClassMatcher.nameEquals(
                "com.example.sermant.agentcore.test.application.tests.methodmatch.MethodMatchersTest");
    }
        ...
        return new InterceptDeclarer[]{
                ...
                InterceptDeclarer.build(
                        MethodMatcher.isAnnotatedWith(
                                "com.example.sermant.agentcore.test.application.common.TestAnnotationA"),
                        new SetEnhanceFlagInterceptor()),
                InterceptDeclarer.build(
                        MethodMatcher.isAnnotatedWith(
                                "com.example.sermant.agentcore.test.application.common.TestAnnotationA",
                                "com.example.sermant.agentcore.test.application.common.TestAnnotationB"),
                        new SetEnhanceFlagInterceptor())};
    }
}
