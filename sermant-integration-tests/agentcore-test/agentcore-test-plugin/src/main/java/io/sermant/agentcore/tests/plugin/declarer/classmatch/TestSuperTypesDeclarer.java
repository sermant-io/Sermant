...
/**
 * Test class matching by superclass
 *
 * @author luanwenfei
 * @since 2023-09-07
 */
public class TestSuperTypesDeclarer extends AbstractPluginDeclarer {
    ...
    public ClassMatcher getClassMatcher() {
        return ClassMatcher.isExtendedFrom("com.example.sermant.agentcore.test.application.common.TestSuperTypeA",
                "com.example.sermant.agentcore.test.application.common.TestSuperTypeB");
    }
