...
public class BootRegistryController {
    ...
    public String urlConnectionPostNoEntity() {
        String params = "";
    ...
    public String urlConnectionGet() {
    ...
    public String urlConnectionRetry() {
    ...
    private String urlConnection(String url, String params, Map<String, String> headers, String method) {
        ...
        try {
            ...
            LOGGER.error(String.format("[Post-JSON] request error, url:%s, params:%s", url, params), e);
            return result;
        } finally {
            if (connection != null) {
