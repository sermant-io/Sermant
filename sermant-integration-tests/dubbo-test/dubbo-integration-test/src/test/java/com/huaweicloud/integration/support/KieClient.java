...
package com.huaweicloud.integration.support;

import com.huaweicloud.integration.support.entity.KieConfigEntity;
import com.huaweicloud.integration.support.entity.KieResponse;
import com.huaweicloud.integration.support.utils.LabelGroupUtils;
...
public class KieClient {
    ...
    public boolean addKey(String key, String value) {
        ...
        HttpEntity<String> entity = new HttpEntity<>(JSONObject.toJSONString(new KieRequest(key, value, labels)),
            headers);
    ...
    public List<KieConfigEntity> query(Map<String, String> labels) {
        ...
        final ResponseEntity<String> result = restTemplate.getForEntity(address, String.class);
        if (result.getStatusCode().value() == 200) {
            final KieResponse kieResponse = JSONObject.parseObject(result.getBody(), KieResponse.class);
