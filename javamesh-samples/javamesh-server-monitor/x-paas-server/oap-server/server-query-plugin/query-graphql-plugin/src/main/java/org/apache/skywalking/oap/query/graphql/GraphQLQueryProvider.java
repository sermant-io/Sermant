...
import com.huawei.oap.query.graphql.DruidQuery;
import com.huawei.oap.query.graphql.ServerMonitorQuery;
...
public class GraphQLQueryProvider extends ModuleProvider {
    ...
    public void prepare() throws ServiceNotProvidedException, ModuleStartException {
        GraphQLSchema schema = SchemaParser.newParser()
                ...
                .file("query-protocol/druid.graphqls")  // huawei update
                .resolvers(new DruidQuery(getManager(), config)) // huawei update
                .file("query-protocol/disk.graphqls")  // huawei update
                .resolvers(new ServerMonitorQuery(getManager())) // huawei update
                .build()
