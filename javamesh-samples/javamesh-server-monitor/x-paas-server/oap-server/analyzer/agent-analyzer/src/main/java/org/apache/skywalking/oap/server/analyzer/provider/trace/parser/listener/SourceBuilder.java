...
class SourceBuilder {
    ...
    Service toService() {
        ...
        service.setCopy(copy); // huawei update.无损演练：添加复制标签
        return service;
    }
    ...
    ServiceRelation toServiceRelation() {
        ...
        serviceRelation.setCopy(copy); // huawei update.无损演练：添加复制标签
    ...
    ServiceInstance toServiceInstance() {
        ...
        serviceInstance.setCopy(copy); // huawei update.无损演练：添加复制标签
    ...
    Endpoint toEndpoint() {
        ...
        endpoint.setCopy(copy); // huawei update.无损演练：添加复制标签
        return endpoint;
    }
    ...
    EndpointRelation toEndpointRelation() {
        ...
        endpointRelation.setCopy(copy); // huawei update.无损演练：添加复制标签
    ...
    DatabaseAccess toDatabaseAccess() {
        ...
        databaseAccess.setCopy(copy); // huawei update.无损演练：添加复制标签
