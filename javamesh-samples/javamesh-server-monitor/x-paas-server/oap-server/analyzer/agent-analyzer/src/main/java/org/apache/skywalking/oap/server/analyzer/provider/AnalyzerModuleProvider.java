...
public class AnalyzerModuleProvider extends ModuleProvider {
    ...
    public void prepare() throws ServiceNotProvidedException, ModuleStartException {
        ...
        // Huawei update, log: 补全后的segment写入kafka
    ...
    public void start() throws ModuleStartException {
        segmentParserService.setKafkaService(
            getManager().find(KafkaProducerModule.NAME).provider().getService(IKafkaService.class));
