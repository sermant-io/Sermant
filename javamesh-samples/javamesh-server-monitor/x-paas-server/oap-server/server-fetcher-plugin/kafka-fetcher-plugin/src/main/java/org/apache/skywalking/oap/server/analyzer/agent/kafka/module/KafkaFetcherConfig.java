...
public class KafkaFetcherConfig extends ModuleConfig {
    ...
    /**
     * topic of connection pool to collect metric
     * includes
     * activeCount
     * poolingCount
     * maxActive
     */
    private String topicNameOfDataSource = "topic-connection-pool-metric";

    private String topicNameOfServerMonitor = "topic-server-monitor";

    // update Huawei,change log: 设置kafka安全偏移量
    /**
     * kafka安全偏移量
     */
    private int safeOffset = 1000;
}
