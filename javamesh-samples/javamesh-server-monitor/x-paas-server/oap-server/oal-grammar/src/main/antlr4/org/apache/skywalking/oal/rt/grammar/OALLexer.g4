...
// huawei update line 48-53
CONNECTION_POOL_METRIC: 'ConnectionPoolMetric';
SRC_SERVER_MONITOR_CPU: 'ServerMonitorCPUMetric';
SRC_SERVER_MONITOR_DISK: 'ServerMonitorDiskMetric';
SRC_SERVER_MONITOR_NETWORK: 'ServerMonitorNetWorkMetric';
SRC_SERVER_MONITOR_MEMORY: 'ServerMonitorMemoryMetric';
SRC_SERVICE_INSTANCE_IBM_JVM_MEMORY_POOL: 'ServiceInstanceIBMJVMMemoryPool';
