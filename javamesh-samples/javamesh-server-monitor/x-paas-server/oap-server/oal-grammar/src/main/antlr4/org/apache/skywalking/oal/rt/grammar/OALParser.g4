...
source
    : SRC_ALL | SRC_SERVICE | SRC_DATABASE_ACCESS | SRC_SERVICE_INSTANCE | SRC_ENDPOINT |
      ...
      SRC_ENVOY_INSTANCE_METRIC | CONNECTION_POOL_METRIC |
      SRC_SERVER_MONITOR_CPU | SRC_SERVER_MONITOR_DISK | SRC_SERVER_MONITOR_NETWORK | SRC_SERVER_MONITOR_MEMORY | //huawei update server monitor
      SRC_SERVICE_INSTANCE_IBM_JVM_MEMORY_POOL //huawei update jvm memory pool
    ;
