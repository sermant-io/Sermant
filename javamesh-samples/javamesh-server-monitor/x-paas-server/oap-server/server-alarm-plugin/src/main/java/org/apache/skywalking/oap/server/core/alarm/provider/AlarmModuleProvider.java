...
import com.huawei.skywalking.oap.server.core.alarm.producer.AlarmKafkaProducer;
...
public class AlarmModuleProvider extends ModuleProvider {
    ...
    // updated by huawei 20210727
    private final AlarmSettings alarmSettings = new AlarmSettings();
    ...
    public void prepare() throws ServiceNotProvidedException, ModuleStartException {
        ...
        // updated by huawei 20210727
        KafkaProducer<String, String> kafkaProducer = AlarmKafkaProducer.getAlarmKafkaProducer()
                                                                        .getKafkaProducer(alarmSettings);
        notifyHandler = new NotifyHandler(alarmRulesWatcher, alarmSettings, kafkaProducer);
