...
import org.apache.skywalking.oap.server.core.storage.ParallelPersistenceTimer;
...
public class CoreModuleProvider extends ModuleProvider {
    ...
    public void notifyAfterCompleted() throws ModuleStartException {
        ...
        // if (!CoreModuleConfig.Role.Receiver.name().equalsIgnoreCase(moduleConfig.getRole())) {
        if (moduleConfig.isSerializeAggregate()) {
            PersistenceTimer.INSTANCE.start(getManager(), moduleConfig);
        } else {
            ParallelPersistenceTimer.INSTANCE.start(getManager(), moduleConfig);
        }
        // }
