 ...
 */
@ScopeDeclaration(
        id = ExtScopeDefine.SERVER_MONITOR_NETWORK_METRIC,
        name = "ServerMonitorNetWorkMetric",
...
@ScopeDefaultColumn.VirtualColumnDefinition(
        ...
        isID = true,
        type = String.class)
public class ServerMonitorNetWorkMetric extends Source {
    @Getter
    @Setter
    private String id;
    @Getter
    ...
    @Override
    public int scope() {
        return ExtScopeDefine.SERVER_MONITOR_NETWORK_METRIC;
    }
