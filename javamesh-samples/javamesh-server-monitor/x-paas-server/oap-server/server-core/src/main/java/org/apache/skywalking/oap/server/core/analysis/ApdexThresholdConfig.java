...
import com.huawei.apm.core.util.SafeYamlConstructor;
...
public class ApdexThresholdConfig extends ConfigChangeWatcher implements ConfigurationDictionary {
    ...
    private void updateConfig(final Reader contentRender) {
        // huawei update. yaml 安全问题 20210525
        dictionary = (Map<String, Integer>) new Yaml(new SafeYamlConstructor()).load(contentRender);
        if (dictionary == null) {
