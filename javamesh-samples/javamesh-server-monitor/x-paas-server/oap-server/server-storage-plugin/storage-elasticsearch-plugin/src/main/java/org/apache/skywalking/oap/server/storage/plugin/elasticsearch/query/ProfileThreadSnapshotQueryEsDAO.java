...
public class ProfileThreadSnapshotQueryEsDAO extends EsDAO implements IProfileThreadSnapshotQueryDAO {
    ...
    public List<BasicTrace> queryProfiledSegments(String taskId) throws IOException {
        ...
        String indexName = ProfileThreadSnapshotRecord.INDEX_NAME;
        ...
        indexName = SegmentRecord.INDEX_NAME;
        // huawei update.无损演练：查询新增flag值
        if (DrillThreadLocal.isDrillFlag()) {
            indexName = indexName + BaseReplicator.COPY_FLAG;
        }
        response = getClient().search(indexName, sourceBuilder);
    ...
    public SegmentRecord getProfiledSegment(String segmentId) throws IOException {
        ...
        String indexName = SegmentRecord.INDEX_NAME;
        // huawei update.无损演练：查询新增flag值
        if (DrillThreadLocal.isDrillFlag()) {
            indexName = indexName + BaseReplicator.COPY_FLAG;
        }
