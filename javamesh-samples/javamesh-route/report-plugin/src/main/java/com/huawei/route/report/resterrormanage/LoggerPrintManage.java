...
package com.huawei.route.report.resterrormanage;
 ...
 * @since 2021-08-09
 */
public class LoggerPrintManage {
    ...
    private LoggerPrintManage() {
    }

    private static LoggerPrintManage loggerPrintManage = null;
     ...
     */
    public static LoggerPrintManage getInstance() {
        if (loggerPrintManage == null) {
            loggerPrintManage = new LoggerPrintManage();
        }
