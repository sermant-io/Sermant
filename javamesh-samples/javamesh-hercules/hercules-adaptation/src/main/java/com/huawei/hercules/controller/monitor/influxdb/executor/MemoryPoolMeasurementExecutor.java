 ...
 * @since 2021-11-14
 */
public class MemoryPoolMeasurementExecutor extends InfluxDBSqlExecutor<MemoryPoolMeasurement> {
    @Override
    protected MemoryPoolMeasurement handleRecord(FluxRecord record) {
        return null;
    }
}
