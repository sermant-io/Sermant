...
if [[ ! -f ~/.m2/repository/org/ngrinder/ngrinder-core/3.4.2/ngrinder-core-3.4.2.jar ]] ; then
	mvn install:install-file -Dfile=lib/ngrinder-core-3.4.2.jar -DgroupId=org.ngrinder -DartifactId=ngrinder-core -Dversion=3.4.2 -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
fi

if [[ ! -f ~/.m2/repository/org/ngrinder/ngrinder-groovy/3.4.2/ngrinder-groovy-3.4.2.jar ]] ; then
	mvn install:install-file -Dfile=lib/ngrinder-groovy-3.4.2.jar -DgroupId=org.ngrinder -DartifactId=ngrinder-groovy -Dversion=3.4.2 -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
fi

if [[ ! -f ~/.m2/repository/org/ngrinder/ngrinder-runtime/3.4.2/ngrinder-runtime-3.4.2.jar ]] ; then
	mvn install:install-file -Dfile=lib/ngrinder-runtime-3.4.2.jar -DgroupId=org.ngrinder -DartifactId=ngrinder-runtime -Dversion=3.4.2 -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
fi

if [[ ! -f ~/.m2/repository/sonia/svnkit/svnkit/1.8.4-scm1/svnkit-1.8.4-scm1.jar ]] ; then
	mvn install:install-file -Dfile=lib/svnkit-1.8.4-scm1.jar -DgroupId=sonia.svnkit -DartifactId=svnkit -Dversion=1.8.4-scm1 -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
fi

if [[ ! -f ~/.m2/repository/sonia/svnkit/svnkit-dav/1.8.4-scm1/svnkit-dav-1.8.4-scm1.jar ]] ; then
	mvn install:install-file -Dfile=lib/svnkit-dav-1.8.4-scm1.jar -DgroupId=sonia.svnkit -DartifactId=svnkit-dav -Dversion=1.8.4-scm1 -Dpackaging=jar -DgeneratePom=true -DcreateChecksum=true
fi
