...
//		properties.setProperty("hibernate.ddl-auto", "update");
//		properties.setProperty("hibernate.ddlAuto", "update");
//		emf.setJpaProperties(properties);
//		Map jpaPropMap = new HashMap<>();
//		jpaPropMap.put("hibernate.hbm2ddl.auto", "update");
//		emf.setJpaPropertyMap(jpaPropMap);
		// To search entity packages from other jar files..
		emf.setPackagesToScan("empty");
//		emf.setPackagesToScan("org.ngrinder");
