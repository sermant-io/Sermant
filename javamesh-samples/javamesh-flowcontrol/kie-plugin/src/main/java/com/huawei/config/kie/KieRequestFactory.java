...
public class KieRequestFactory {
     ...
     * @return KieRequest
     */
    public static KieRequest buildKieRequest(String wait, String revision, String ...labels) {
        final KieRequest kieRequest = new KieRequest();
        return kieRequest.setRevision(revision).setWait(wait).setLabelCondition(buildLabels(labels));
    }
     ...
     * @return KieRequest
     */
    public static KieRequest buildKieRequest(String revision, String labelCondition) {
        final KieRequest kieRequest = new KieRequest();
        return kieRequest.setRevision(revision).setLabelCondition(labelCondition);
    }
     ...
     * @return KieRequest
     */
    public static KieRequest buildKieRequest(String wait, String revision, String labelCondition) {
        final KieRequest kieRequest = new KieRequest();
        return kieRequest.setWait(wait).setRevision(revision).setLabelCondition(labelCondition);
    }
     ...
     * @return KieRequest
     */
    public static KieRequest buildKieRequest(String ...labels) {
     ...
     * @return KieRequest
     */
    public static KieRequest buildKieRequest(String wait, String ...labels) {
     ...
     * @return KieRequest
     */
    public static KieRequest buildKieRequest(Map<String, String> labels) {
     ...
     * @return KieRequest
     */
    public static KieRequest buildKieRequest(String wait, String revision, Map<String, String> labels) {
        final KieRequest kieRequest = new KieRequest();
        kieRequest.setLabelCondition(buildMapLabels(labels));
        return kieRequest.setWait(wait).setRevision(revision);
    }
