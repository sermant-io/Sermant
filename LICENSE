...
Some files in this project contain a portion of the following project and we have declared in each file.

1. Apache Skywalking project.
...
2. Alibaba Sentinel project.
Alibaba Sentinel project is published at https://github.com/alibaba/Sentinel and its license is Apache License Version 2.0.

3. Alibaba spring-cloud-alibaba project.
Alibaba spring-cloud-alibaba project is published at https://github.com/alibaba/spring-cloud-alibaba and its license is Apache License Version 2.0.

4. Apache ServiceComb Java Chassis project.
...
7. openEuler gala-gopher project.
openEuler gala-gopher project is published at https://gitee.com/openeuler/gala-gopher and its license is Mulan PSL v2.
